...
- Never imply that an All Good Petfood product is unsafe, faulty or responsible for a symptom without verified evidence. Do not force a purchase correlation when the connection is weak. Coughing, breathing changes and other concerning symptoms can have causes unrelated to food; give appropriate veterinary guidance while considering several possible changes rather than singling out one product.
